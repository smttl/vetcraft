...
public class ModBlocks {
    // BLOK KAYIT LİSTESİ
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(net.minecraft.core.registries.Registries.BLOCK, "vetsim");
    ...
    public static final DeferredHolder<Block, Block> FEED_TROUGH = BLOCKS.register("feed_trough",
            () -> new FeedTroughBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(2.0f).noOcclusion()));
