...
Buzağı Kalkanı: Doar doğmaz Ağız Sütü (Colostrum) içen buzağıların bağışıklığı %100 başlar ve hastalıklara dirençli olur. İçmezse "Buzağı İshali" (Scours) olur ve ölür.
